...
#define LAYOUT_LAYER_MEDIA                                                                    \
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, EE_CLR,  QK_BOOT, QK_BOOT, EE_CLR,  KC_MUTE, XXXXXXX, XXXXXXX, \
...
const uint16_t PROGMEM caps_combo1[] = {LSFT_T(KC_T), RSFT_T(KC_N), COMBO_END};
const uint16_t PROGMEM caps_combo2[] = {LSFT_T(KC_F), RSFT_T(KC_J), COMBO_END};
combo_t key_combos[] = {
    COMBO(caps_combo1, CW_TOGG),
    COMBO(caps_combo2, CW_TOGG),
};
