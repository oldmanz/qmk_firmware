...
#define LAYOUT_LAYER_MEDIA                                                                    \
    XXXXXXX,RGB_RMOD, KC_VOLU, RGB_MOD, XXXXXXX, XXXXXXX,RGB_RMOD, KC_VOLU, RGB_MOD, XXXXXXX, \
...
#define LAYOUT_LAYER_NUMERAL                                                                  \
    KC_LBRC,    KC_7,    KC_8,    KC_9, KC_RBRC, TG_BASE, TG_GAME , XXXXXXX,XXXXXXX,XXXXXXX, \
